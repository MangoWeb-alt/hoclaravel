        ...
        <div class="position-center">
            ...
            <form action="{{URL::to('/update-category/'.$value_category->category_id)}}" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="category_slug" data-validation="length" data-validation-length="min3" class="form-control" id="exampleInputEmail1" value="{{$value_category->category_slug}}">
                </div>
                <div class="form-group">
